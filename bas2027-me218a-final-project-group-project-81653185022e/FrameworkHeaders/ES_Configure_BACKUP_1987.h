...
// the header file with the public function prototypes
<<<<<<< HEAD
#define SERV_2_HEADER "CoinLEDService.h"
// the name of the Init function
#define SERV_2_INIT InitCoinLEDService
// the name of the run function
#define SERV_2_RUN RunCoinLEDService
=======
...
>>>>>>> a0ac02d (Potentiometer and Servo services combined into framework (not interlinked yet). Each is working individually)
// How big should this services Queue be?
...
<<<<<<< HEAD
#define EVENT_CHECK_LIST Check4Keystroke, Check4Coin
=======
#define EVENT_CHECK_LIST Check4Keystroke, CheckADEvent
>>>>>>> a0ac02d (Potentiometer and Servo services combined into framework (not interlinked yet). Each is working individually)
