...
#if NUM_SERVICES > 2
// the header file with the public function prototypes
#define SERV_2_HEADER "PotService.h"
// the name of the Init function
#define SERV_2_INIT InitPotService
// the name of the run function
#define SERV_2_RUN RunPotService
// How big should this services Queue be?
...
#if NUM_SERVICES > 3
// the header file with the public function prototypes
#define SERV_3_HEADER "BuzzerService.h"
// the name of the Init function
#define SERV_3_INIT InitBuzzerService
// the name of the run function
#define SERV_3_RUN RunBuzzerService
// How big should this services Queue be?
...
#if NUM_SERVICES > 5
// the header file with the public function prototypes
#define SERV_5_HEADER "WelcomeService.h"
// the name of the Init function
#define SERV_5_INIT InitWelcomeService
// the name of the run function
#define SERV_5_RUN RunWelcomeService
// How big should this services Queue be?
...
#if NUM_SERVICES > 6
// the header file with the public function prototypes
#define SERV_6_HEADER "GameCountDownService.h"
// the name of the Init function
#define SERV_6_INIT InitGameCountDownService
// the name of the run function
#define SERV_6_RUN RunGameCountDownService
// How big should this services Queue be?
...
#if NUM_SERVICES > 7
// the header file with the public function prototypes
#define SERV_7_HEADER "CoinLEDService.h"
// the name of the Init function
#define SERV_7_INIT InitCoinLEDService
// the name of the run function
#define SERV_7_RUN RunCoinLEDService
// How big should this services Queue be?
...
#if NUM_SERVICES > 8
// the header file with the public function prototypes
#define SERV_8_HEADER "ButtonService.h"
// the name of the Init function
#define SERV_8_INIT InitButtonService
// the name of the run function
#define SERV_8_RUN RunButtonService
// How big should this services Queue be?
...
#define EVENT_CHECK_LIST Check4Keystroke, CheckADEvent, Check4Coin, CheckButton
...
#define TIMER10_RESP_FUNC PostWelcomeService
#define TIMER11_RESP_FUNC PostButtonService
#define TIMER12_RESP_FUNC PostBuzzerService
#define TIMER13_RESP_FUNC PostGameCountDownService
#define TIMER14_RESP_FUNC PostWelcomeService
...
#define WELCOME_TIMER 14
#define FULL_GAME_TIMER 13 //should be one second and then check the variable storing number of times Time expired
#define AFK_TIMER 12 //20 second timer the user doesn't see
#define RELOAD_TIMER 11 //1 second timer for reloading (buzzer on for this duration)
#define RETURN_WELCOME_TIMER 10 //return from gameover to welcome state
